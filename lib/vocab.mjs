...
/**
 * The caption vocabulary, grouped by the dimensions the ACE-Step authors ask
 * for, and used to EDIT a caption rather than to compose one from nothing.
 *
 ...
 * group drawn as a wall), `many` stays chips because you really do pick several
 * instruments and several textures.
 */
export const CHIPS = [
  ['Genre', ['cinematic orchestral', 'lo-fi hip hop', 'synthwave', 'ambient', 'cumbia', 'afrobeat',
    'drum and bass', 'bossa nova', 'gospel', 'post-rock', 'techno', 'jazz trio', 'trap', 'folk'], 'one'],
  ['Mood', ['patient and hopeful', 'tense', 'euphoric', 'melancholic', 'playful', 'menacing',
    'nostalgic', 'triumphant', 'intimate', 'secretive'], 'one'],
  ['Instruments', ['warm sustained strings', 'low piano ostinato', 'french horn', 'soft timpani',
    ...
    'live percussion', 'hand claps', 'harp', 'muted trumpet', 'church organ', '808 sub'], 'many'],
  ['Voice', ['female lead vocal', 'male lead vocal', 'layered choir', 'whispered vocal',
    'gang vocals', 'no vocals'], 'one'],
  ['Texture', ['wide concert hall reverb', 'tape saturation', 'sidechained pads', 'dry and close',
    'vinyl crackle', 'heavy sub weight', 'bright modern master', 'deep stone-room reverb'], 'many']
]
